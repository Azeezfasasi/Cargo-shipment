...
export default function WhoWeAre() {
  ...
  return (
    <section className="relative bg-red-100 font-sans overflow-hidden">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
        {/* Left Section: Content */}
        <div className="lg:w-1/2 w-full bg-red-600 text-white p-8 md:p-16 lg:p-20 relative z-10 lg:rounded-r-full lg:mr-[-100px] lg:pr-32">
